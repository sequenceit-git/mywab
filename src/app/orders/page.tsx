  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-950">
      ...
      <main className="p-6 max-w-7xl mx-auto w-full space-y-6">
        {/* Filter & Search Bar */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-4 rounded-2xl bg-dark-900/90 border border-slate-800/80 shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {/* Pagination Controls */}
            {filteredOrders.length > 0 && (
              <div className="p-4 rounded-2xl bg-dark-900/90 border border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
                <div className="text-slate-400">
                  ...
                  {filterStatus !== 'ALL' && <span className="text-slate-500"> (Filtered: {filterStatus})</span>}
                </div>
          ...
          <div className="space-y-4">
            {selectedOrder ? (
              <div className="p-5 rounded-2xl bg-dark-900/90 border border-slate-800/80 space-y-4 sticky top-24 shadow-2xl">
                ...
                <div className="pt-2 border-t border-slate-800 space-y-2">
                  ...
                  {selectedOrder.status !== 'CANCELLED' ? (
                    ...
                    <div className="p-3 rounded-xl bg-rose-950/30 border border-rose-500/30 text-xs text-rose-300 space-y-1 text-center">
                      ...
                      <button
                        onClick={() => handleUpdateStatus(selectedOrder.order_id, 'PENDING_CLAIM')}
                        className="mt-2 py-1 px-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-[11px] text-slate-200 transition"
                      >
